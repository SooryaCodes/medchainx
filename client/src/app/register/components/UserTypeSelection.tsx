  ...
  return (
    <div className="space-y-10">
      <div className="text-center">
        <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent mb-4">
          Join MedChainX
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
        {[
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-600/5 to-blue-500/5 group-hover:from-blue-600/10 group-hover:to-blue-500/10 transition-all duration-300"></div>
            ...
            <div className="h-1 w-0 bg-gradient-to-r from-blue-600 to-blue-500 group-hover:w-full transition-all duration-300"></div>
          </div>
        ))}
      </div>
    </div>
